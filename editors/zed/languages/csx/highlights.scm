...
((element_tag) @type
  (#match? @type "^(View|Text|Image|ScrollView|FlatList|SectionList|VirtualizedList|Pressable|TouchableOpacity|TouchableHighlight|TouchableWithoutFeedback|TextInput|SafeAreaView|SafeAreaProvider|StatusBar|ActivityIndicator|Switch|Slider|Picker|WebView|KeyboardAvoidingView|Animated\\.View)$"))
