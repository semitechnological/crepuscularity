//! This crate provides Crepus language support for the [tree-sitter][] parsing library.
//!
...
//! parser.set_language(&tree_sitter_crepus::language()).expect("Error loading Crepus grammar");
...
extern "C" {
    fn tree_sitter_crepus() -> Language;
}
