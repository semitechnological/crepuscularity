...
pub use capabilities::{
    ...
    ANDROID_GEOLOCATION_BRIDGE, ANDROID_HAPTICS, ANDROID_IMAGE_PICKER, ANDROID_IN_APP_BROWSER,
    ANDROID_KEYBOARD, ANDROID_LOCAL_NOTIFICATIONS, ANDROID_NETWORK, ANDROID_PERMISSIONS,
    ...
    IOS_IN_APP_BROWSER, IOS_KEYBOARD, IOS_LOCAL_NOTIFICATIONS, IOS_NETWORK, IOS_PERMISSIONS,
    IOS_PHOTO_LIBRARY, IOS_PHOTO_LIBRARY_BRIDGE, IOS_PREFERENCES, IOS_SCREEN_ORIENTATION,
    IOS_SECURE_STORAGE, IOS_SENSORS, IOS_SENSORS_BRIDGE, IOS_SETTINGS, IOS_SHARE, IOS_SYSTEM_BARS,
};
