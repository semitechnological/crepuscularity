...
pub use capabilities::{
    ...
    ANDROID_PREFERENCES, ANDROID_SCHEDULED_NOTIFICATION_RECEIVER, ANDROID_SCREEN_ORIENTATION,
    ANDROID_SECURE_STORAGE, ANDROID_SENSORS, ANDROID_SENSORS_BRIDGE, ANDROID_SETTINGS,
    ANDROID_SHARE, ANDROID_SYSTEM_BARS, ANDROID_TOAST, IOS_ACCESSIBILITY_INFO, IOS_ACTION_SHEET,
    ...
    IOS_SHARE, IOS_SYSTEM_BARS, IOS_TOAST,
};
