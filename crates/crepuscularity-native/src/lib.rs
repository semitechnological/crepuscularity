...
pub use capabilities::{
    ...
    ANDROID_SENSORS_BRIDGE, IOS_APPEARANCE, IOS_BATTERY, IOS_BLUETOOTH, IOS_BLUETOOTH_BRIDGE,
    IOS_GEOLOCATION, IOS_GEOLOCATION_BRIDGE, IOS_HAPTICS, IOS_SENSORS, IOS_SENSORS_BRIDGE,
};
