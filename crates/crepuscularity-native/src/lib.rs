...
pub use capabilities::{
    ...
    ANDROID_PHOTO_LIBRARY, ANDROID_SCREEN_ORIENTATION, ANDROID_SENSORS, ANDROID_SENSORS_BRIDGE,
    ...
    IOS_CAMERA, IOS_CAMERA_BRIDGE, IOS_CLIPBOARD, IOS_CLIPBOARD_BRIDGE, IOS_DIALOG,
