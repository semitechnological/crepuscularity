...
pub use capabilities::{
    ANDROID_ACCESSIBILITY_INFO, ANDROID_ACTION_SHEET, ANDROID_APPEARANCE, ANDROID_APP_STATE,
    ANDROID_BATTERY, ANDROID_BIOMETRICS, ANDROID_BLUETOOTH, ANDROID_BLUETOOTH_BRIDGE,
    ANDROID_BROWSER, ANDROID_CAMERA, ANDROID_CLIPBOARD, ANDROID_DEVICE, ANDROID_DIALOG,
    ANDROID_DIMENSIONS, ANDROID_DOCUMENT_PICKER, ANDROID_GEOLOCATION, ANDROID_GEOLOCATION_BRIDGE,
    ANDROID_HAPTICS, ANDROID_IMAGE_PICKER, ANDROID_KEYBOARD, ANDROID_LOCAL_NOTIFICATIONS,
    ...
    IOS_APPEARANCE, IOS_APP_STATE, IOS_BATTERY, IOS_BIOMETRICS, IOS_BLUETOOTH,
