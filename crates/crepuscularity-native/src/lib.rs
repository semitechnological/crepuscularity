...
pub use capabilities::{
    ...
    ANDROID_SENSORS, ANDROID_SENSORS_BRIDGE, ANDROID_SHARE, IOS_APPEARANCE, IOS_BATTERY,
    IOS_BLUETOOTH, IOS_BLUETOOTH_BRIDGE, IOS_BROWSER, IOS_CLIPBOARD, IOS_CLIPBOARD_BRIDGE,
