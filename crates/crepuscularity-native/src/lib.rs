...
pub use capabilities::{
    ANDROID_APPEARANCE, ANDROID_BATTERY, ANDROID_BLUETOOTH, ANDROID_BLUETOOTH_BRIDGE, ANDROID_GEOLOCATION, ANDROID_GEOLOCATION_BRIDGE,
    ANDROID_SENSORS, ANDROID_SENSORS_BRIDGE, IOS_GEOLOCATION, IOS_GEOLOCATION_BRIDGE,
    IOS_APPEARANCE, IOS_BATTERY, IOS_SENSORS, IOS_SENSORS_BRIDGE,
};
