...
pub use capabilities::{
    ...
    ANDROID_BROWSER, ANDROID_CLIPBOARD, ANDROID_GEOLOCATION, ANDROID_GEOLOCATION_BRIDGE,
    ANDROID_HAPTICS, ANDROID_SENSORS, ANDROID_SENSORS_BRIDGE, ANDROID_SHARE, IOS_APPEARANCE,
