...
pub use capabilities::{
    ANDROID_APPEARANCE, ANDROID_BATTERY, ANDROID_BLUETOOTH, ANDROID_BLUETOOTH_BRIDGE,
    ANDROID_BROWSER, ANDROID_CLIPBOARD, ANDROID_DOCUMENT_PICKER, ANDROID_GEOLOCATION,
    ANDROID_GEOLOCATION_BRIDGE, ANDROID_HAPTICS, ANDROID_IMAGE_PICKER, ANDROID_SENSORS,
    ANDROID_SENSORS_BRIDGE, ANDROID_SHARE, IOS_APPEARANCE, IOS_BATTERY, IOS_BLUETOOTH,
    IOS_BLUETOOTH_BRIDGE, IOS_BROWSER, IOS_CLIPBOARD, IOS_CLIPBOARD_BRIDGE, IOS_DOCUMENT_PICKER,
    IOS_GEOLOCATION, IOS_GEOLOCATION_BRIDGE, IOS_HAPTICS, IOS_IMAGE_PICKER,
    IOS_IMAGE_PICKER_BRIDGE, IOS_SENSORS, IOS_SENSORS_BRIDGE, IOS_SHARE,
};
