...
pub use capabilities::{
    ANDROID_ACTION_SHEET, ANDROID_APPEARANCE, ANDROID_BATTERY, ANDROID_BLUETOOTH,
    ...
    ANDROID_SENSORS_BRIDGE, ANDROID_SHARE, IOS_ACTION_SHEET, IOS_ACTION_SHEET_BRIDGE,
    IOS_APPEARANCE, IOS_BATTERY, IOS_BLUETOOTH, IOS_BLUETOOTH_BRIDGE, IOS_BROWSER, IOS_CAMERA,
    IOS_CAMERA_BRIDGE, IOS_CLIPBOARD, IOS_CLIPBOARD_BRIDGE, IOS_DIALOG, IOS_DIALOG_BRIDGE,
    IOS_DIMENSIONS, IOS_DOCUMENT_PICKER, IOS_GEOLOCATION, IOS_GEOLOCATION_BRIDGE, IOS_HAPTICS,
    IOS_IMAGE_PICKER, IOS_IMAGE_PICKER_BRIDGE, IOS_PHOTO_LIBRARY, IOS_PHOTO_LIBRARY_BRIDGE,
