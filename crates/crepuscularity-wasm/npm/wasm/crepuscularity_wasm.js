/* @ts-self-types="./crepuscularity_wasm.d.ts" */
 ...
 * @returns {string}
 */
function parse_crepus_json(source, context_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.parse_crepus_json(retptr, ptr0, len0, ptr1, len1);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./crepuscularity_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/crepuscularity_wasm_bg.wasm`;
